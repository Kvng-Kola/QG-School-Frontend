...
export default function LessonListpage() {
    ...
    async function LessonsData() {
      try {
        ...
        const response = await axios.get(
          `http://localhost:8000/api/lessonList`
        );
  ...
  const filteredData = useMemo(() => {
    ...
    // Filter by subject and return lowercase version of subject for case-insensitive search
    ...
    <DLayout>
      <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
        ...
        <div className="flex items-center justify-between">
          <h1 className="hidden sm:block font-semibold text-lg">All Lessons</h1>
